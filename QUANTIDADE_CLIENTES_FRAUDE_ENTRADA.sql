--- ESSA QUERY CONSULTA E CONTA A QUANTIDADE DE CLIENTES QUE FORAM VÍTIMAS DE FRAUDE EM CADA MÊS, E CONTABILIZA APENAS OS CLIENTES ÚNICOS NAS TRANSAÇÕES DE FRAUDE ENTRADA.
